...
```
RuntimeError: Error code: 404 - {'error': {'message': 'The model `deepseek_v4_pro` does not exist.', 'type': 'NotFoundError', 'param': 'model', 'code': 404}}
```
