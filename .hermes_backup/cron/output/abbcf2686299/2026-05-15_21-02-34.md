...
**赵建玲** — 入职日 (5/6) 已过9天，档案状态为「已入职」但入职时间表仍标为「⚠️ 已逾期」，建议核实实际入职情况并更新状态。

### 🔴 逾期面试提醒

| 候选人 | 轮次 | 原定日期 | 状态 |
|--------|------|----------|------|
| **张杰** | 二面 | 2025-07-28 | ⚠️ **已逾期近10个月** — 需确认是否仍有效 |
| **王展鸿** | 一面 | 2025-07-29 | ⚠️ **已逾期近10个月** — 需确认是否仍有效 |
...
| 🟡 **待入职** | 李馨蔚 (5/20) |
| 🟠 **待发Offer (薪资谈判中)** | 张涵 |
| 🔵 **面试中** | 顾婧 (8/17), 刘子铭 (6/27二面), 孙公瑾 (4/23一面已完成), Eli (6/22), 杜飞龙 (6/28), 张杰, 王展鸿 |
| ⚫ **已淘汰** | 王成 (初筛未通过), 吴昊雨 (主动放弃) |

---

**关注要点：** 李馨蔚下周三 (5/20) 入职，建议本周内完成所有入职预备事项。赵建玲的入职状态需核实更新。
