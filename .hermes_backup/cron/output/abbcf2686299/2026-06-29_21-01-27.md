...
未来7天内（2026-06-29 至 2026-07-06）**无面试安排**。

---

⚠️ **以下面试已逾期仍未完成，建议核实处理：**

| 候选人 | 轮次 | 原定日期 | 状态 |
|--------|------|----------|------|
| **杜飞龙** | 一面 | 2026-06-28（昨天） | 已安排（线上·梁志颖·前端专家岗位） |
| **刘子铭** | 二面 | 2026-06-27（2天前） | 已安排（线上·邱仕宏·16:00） |
| **Eli** | 一面 | 2026-06-22（7天前） | 已安排（线下·Jerry Lin·技术面） |
| **金仁操** | 一面 | 2026-06-04（25天前） | 已安排（应聘：大模型框架开发工程师） |
| **谢明** | 一面 | 2026-05-20（40天前） | 已安排（应聘：AI框架开发工程师） |
| **马硕** | 一面 | 2026-05-19（41天前） | 已安排（应聘：软件开发实习） |
| **张杰** | 二面 | 2025-07-28 | 已逾期近一年，需确认是否仍有效 |
| **王展鸿** | 一面 | 2025-07-29 | 已逾期近一年，需确认是否仍有效 |

**特别提醒：** 杜飞龙（昨天6/28）和 刘子铭（6/27）的面试时间已过，请尽快确认是否已完成或需要重新安排。
