...
- 金仁操、马硕、谢明的一面已过期较久，建议尽快更新面试状态或重新安排The reminder was fully delivered above. To summarize the key action items:

1. **今天 14:00** — Eli 线下一面（Jerry Lin 技术面），请确认场地就绪
2. **6月27日 16:00** — 刘子铭线上二面（邱仕宏），提前准备一面对二面反馈
3. **6月28日 10:00** — 杜飞龙线上二面（梁志颖），前端专家岗位
4. **过期未更新** — 金仁操、马硕、谢明的一面状态需尽快更新或重新安排完整提醒已发送完毕，无需补充。
