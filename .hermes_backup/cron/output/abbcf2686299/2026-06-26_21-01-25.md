...
以下面试已过原定日期但状态仍标记为"已安排"，建议确认是否需要更新状态：

1. **Eli** — 一面 2026-06-22（已过期4天）面试官：Jerry Lin | 线下 | 技术面
2. **金仁操** — 一面 2026-06-04（已过期22天）应聘岗位：大模型框架开发工程师
3. **马硕** — 一面 2026-05-19（已过期38天）应聘岗位：软件开发（实习）
4. **谢明** — 一面 2026-05-20（已过期37天）应聘岗位：AI框架开发工程师
