...
📅 **面试提醒 — 未来7天安排 (2026-05-02 ~ 2026-05-09)**

### 2026-05-07（5天后）
- **[刘子铭]** | 一面 | 11:00 | [待补充] | 面试官：[待补充]
...
**其他候选人状态：**
- **顾婧**、**孙公瑾**、**张涵** — 面试已完成，无后续安排
- **吴昊雨** — 薪资谈判中，Offer阶段
- **李馨蔚** — 已安排入职日 2026-05-20（超出7天范围）
- **刘子铭** 的面试信息（形式、面试官）尚有缺项，建议及时补充。

**⚠️ 已过期面试（日期早于今天且状态未标注已完成）：**
- 无

**日期确认：** 系统时间 `2026-05-02`（通过 `date "+%Y-%m-%d"` 获取）。
