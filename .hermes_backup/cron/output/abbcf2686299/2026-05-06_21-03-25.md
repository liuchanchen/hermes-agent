...
✅ 面试时间表已更新，候选人档案已创建并更新。以下是未来7天（含已录入的近期面试）完整安排：
...
| 候选人 | 轮次 | 时间 | 形式 | 面试官 | 备注 |
|--------|------|------|------|--------|------|
| **刘子铭** | **一面** | **11:00** | 待补充 | 待补充 | — |

> ⚠️ **明天就有面试！** 刘子铭一面即将在不到14小时后进行。建议确认面试形式（已安排但表格中形式/面试官尚未填写）。

## 📋 此后安排一览

| 日期 | 距今天数 | 候选人 | 轮次 | 时间 | 形式 | 面试官 |
|------|---------|--------|------|------|------|--------|
| 2026-05-07 周四 | **1天** ⚡ | 刘子铭 | 一面 | 11:00 | [待定] | [待定] |
| 2026-06-22 周一 | **47天** | Eli | 一面 | 14:00 | 🏢 线下 | Jerry Lin |
| 2026-06-27 周六 | **52天** | 刘子铭 | 二面 | 16:00 | 💻 线上 | 邱仕宏 |
| 2026-06-28 周日 | **53天** | 杜飞龙 | 一面 | 10:00 | 💻 线上 | 梁志颖 |

---

## 📝 已更新的内容

**1. 面试时间表** — 已将 Eli、刘子铭二面、杜飞龙 写入 `面试时间表.md`

**2. 候选人档案已更新:**

| 候选人 | 档案 | 操作 |
|--------|------|------|
| **刘子铭** | `候选人档案/刘子铭.md` | ✅ 更新 — 补充了一面/二面面试记录，更新日期 |
| **Eli** | `候选人档案/Eli.md` | ✅ **新建** — 基本信息 + 一面安排 (Jerry Lin, 线下技术面) |
| **杜飞龙** | `候选人档案/杜飞龙.md` | ✅ **新建** — 基本信息 + 一面安排 (梁志颖, 线上, 前端专家岗) |

**3. 待完善事项:**
- **刘子铭明天一面** — 面试形式和面试官信息待补充，建议立即确认
- **Eli / 杜飞龙** — 简历尚未归档到简历目录，找到后请放入 `招聘/简历/` 并补充档案信息
- 张涵已完成两面且通过，等待薪资谈判，可推进入职流程
- 张杰(2025-07-28)和王展鸿(2025-07-29)是去年的旧记录，建议清理
