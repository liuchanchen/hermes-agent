...
| 项目 | 日期 | 说明 |
|------|------|------|
| **李馨蔚** 入职 | **2026-05-20（8天后）** | 第一天上班，需确认入职材料、工位、设备等准备就绪 |
| **刘子铭** 二面 | 2026-06-27 | 线上，面试官：邱仕宏，需准备一面对二面的反馈 |
| **顾婧** 一面 | 2026-08-17 | 线下，技术面，面试官[待补充] |

---

**总结：** 未来7天（2026-05-13 ~ 2026-05-18）内无待安排的面试。今天王成的面试已完成（初筛未通过），状态已标为已完成，无待办事项。近期最需关注的是**李馨蔚5月20日入职**（8天后），建议提前安排入职准备流程。
