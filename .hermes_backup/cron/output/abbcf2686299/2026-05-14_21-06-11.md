...
| **赵建玲** | 🔴 入职已逾期 | 2026-05-06 | 入职日已过8天，档案标记"已入职"，需确认是否已报到 |

---

## 四、招聘管线全景总览

| 候选人 | 应聘岗位 | 当前阶段 | 最近进展 | 下一步 |
|--------|----------|----------|----------|--------|
| **顾婧** | 算法工程师 | 🔄 一面已安排（08-17） | 档案评估：通过 | 等待面试 |
| **孙公瑾** | [待补充] | ✅ 一面已完成（04-23通过） | 体系结构背景深厚 | 安排二面 |
| **刘子铭** | AI智能体/应用/后端 | ✅ 一面通过 → 🔄 二面已安排（06-27） | 思路清晰，有Agent经验 | 准备二面反馈 |
| **张涵** | 大模型算法/算法优化 | ✅ 两面通过 → 💰 薪资谈判中 | 6年经验，从NLP到LLM全链路 | 推进薪资谈判 |
| **张杰** | [待补充] | ⚠️ 逾期近1年 | 二面（许世杰）未完成 | 建议确认有效性 |
| **王展鸿** | [待补充] | ⚠️ 逾期近1年 | 一面（许世杰）未完成 | 建议确认有效性 |
| **Eli** | [待补充] | 🔄 一面已安排（06-22） | Jerry Lin 面试 | 等待面试 |
| **杜飞龙** | 前端专家 | 🔄 一面已安排（06-28） | 梁志颖 面试 | 等待面试 |
| **王成** | 待定 | ❌ 已淘汰（初筛未通过） | 05-12面试 | — |
| **吴昊雨** | [待补充] | ❌ 已淘汰（主动放弃） | 放弃了Offer | — |
| **李馨蔚** | [待补充] | 🎯 待入职（05-20） | 入职准备中 | 确认入职准备 |
| **赵建玲** | 测试工程师 | ✅ 已入职（待确认） | 05-06入职日 | 确认是否已报到 |

---

### 📌 重点提醒
1. **张涵**的薪资谈判已持续多日，建议设定沟通截止日期
2. **孙公瑾**一面通过已近三周，建议推进二面安排
3. **张杰**和**王展鸿**的逾期面试建议确认是否仍有效，无效则清理
4. **李馨蔚**入职（05-20）需确认各项准备工作就绪
