...
§
Remote GPU server 10.10.70.88: user=jianliu, sudo password="!QAZ2wsx", Ubuntu 22.04, 8× RTX 5090 (Blackwell CC 12.0), driver 580.126.09, CUDA Driver 13.0, nvcc 13.0.88, NCCL 2.28.9-1+cuda13.0 (system), nccl-tests at ~/work/bandwidth_test/nccl-tests/build/.