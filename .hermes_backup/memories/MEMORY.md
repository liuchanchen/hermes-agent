...
§
在10.10.70.98上，临时使用qs用户登录，密码为!QAZ2wsx，之后创建sudo用户jianliu，密码为!QAZ2wsx，并为jianliu设置SSH密钥路径，后续登录使用jianliu用户。
§
...
§
用户通过rsync命令将/data/models/deepseekv4_pro/从10.10.70.88传输到10.10.70.98，进程proc_703655dce7b1已完成，退出码0，传输成功。
§
